...
export async function generateMetadata({ params }: RouteProps): Promise<Metadata> {
  ...
  if (!property) return { title: "Property not found | Eain" };
  return {
    title: `${property.title} | Eain`,
    description: `${formatPropertyPrice(property)} · ${property.bedrooms} bedrooms · ${property.area_sqft} sqft in ${property.township}, ${property.city}. Verified on Eain.`,

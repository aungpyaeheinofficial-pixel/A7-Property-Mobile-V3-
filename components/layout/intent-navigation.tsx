      ...
      {intentLinks.map((item) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "inline-flex h-9 items-center gap-1.5 rounded-full px-4 transition-[transform,background-color,color,box-shadow] duration-200 ease-out hover:bg-white hover:text-[#006AFF] active:scale-[.96]",
              active
                ? "bg-white font-semibold text-[#006AFF] shadow-[0_2px_9px_rgba(23,43,63,.09)]"
                : "text-[#526172]",
            )}
          >

  ...
  return (
    <div ref={rootRef} className={cn("relative", className)}>
      <button
        ...
        className={cn(
          "inline-flex h-10 items-center gap-2 rounded-full px-3 text-xs font-medium text-[#006AFF] transition-[background-color,box-shadow,transform] duration-200 hover:bg-[#F1F6FF] active:scale-[.97]",
          open && "bg-[#EAF2FF] shadow-[inset_0_0_0_1px_rgba(0,106,255,.12)]",
        )}
      >
          ...
          >
            ...
            <div className="px-5 pb-5">
                ...
                {answer ? (
                  ...
                  >
                    <div className="flex gap-3">
                      <span className="mt-0.5 grid size-7 shrink-0 place-items-center rounded-full bg-[#006AFF] text-white">
                        <Check className="size-3.5" strokeWidth={2.5} />
                      </span>
                      <div>
                        <p className="text-[10px] font-medium uppercase tracking-[0.08em] text-[#006AFF]">{tx("A7 starting point", "A7 ၏ စတင်အကြံပြုချက်")}</p>
                  ...
                  >
                    ...
                    <div className="grid gap-2">
                      {(isMyanmar ? quickPromptsMyanmar : quickPrompts).map((prompt) => (
                        ...
                        >
                          <span>{prompt}</span>
                          <ArrowRight className="size-3.5 shrink-0 text-[#8A98A8] transition-transform group-hover:translate-x-0.5 group-hover:text-[#006AFF]" />
                        </button>
                      ))}
                    </div>
                  </motion.div>
              ...
              <form onSubmit={submitQuestion}>
                <div className="flex items-center gap-2 rounded-[16px] border border-[#C9D5E2] bg-white p-1.5 pl-3.5 shadow-[0_5px_16px_rgba(31,55,79,.06)] transition-[border-color,box-shadow] focus-within:border-[#75AEFF] focus-within:shadow-[0_0_0_3px_rgba(0,106,255,.1)]">
                  <input
                    ref={inputRef}
                    type="text"
                    value={question}
                  ...
                  <button
                    ...
                    className="grid size-10 shrink-0 place-items-center rounded-xl bg-[#006AFF] text-white shadow-[0_7px_16px_rgba(0,106,255,.22)] transition-[background-color,transform,opacity] hover:bg-[#005EE5] active:scale-[.95] disabled:cursor-not-allowed disabled:opacity-35"
                  >
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                ...
                <Link
                  href="/assistant"
                  onClick={() => setOpen(false)}
                  className="inline-flex shrink-0 items-center gap-1 text-[10px] font-medium text-[#006AFF] hover:underline"
                >

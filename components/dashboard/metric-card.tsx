...
function MetricCard({ label, value, change, icon: Icon, tone = "jade" }: MetricCardProps) {
  const toneClass = tone === "sand" ? "bg-[#F1F6FF] text-[#53606E]" : tone === "copper" ? "bg-[#E8F0FF] text-[#003F91]" : "bg-[#EEF5FC] text-[#0057D9]";
  return (
    <Card className="group overflow-hidden rounded-[20px] transition-[transform,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(23,43,63,.1)]">
      <CardContent className="relative p-4 sm:p-5">
        <div className="pointer-events-none absolute -right-8 -top-10 size-24 rounded-full bg-[#0057D9]/5 transition-transform duration-300 group-hover:scale-125" />
